...
verify_endpoint "host-meta" "/.well-known/host-meta" "application/xrd+xml; charset=utf-8"
verify_endpoint "nodeinfo" "/.well-known/nodeinfo" "application/json; charset=utf-8"
