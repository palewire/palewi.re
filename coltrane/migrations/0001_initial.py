    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', tagging.fields.TagField(help_text='Separate tags with spaces.', max_length=1000, blank=True)),
                ('title', models.CharField(max_length=250, null=True, blank=True)),
                ('rating', models.FloatField(null=True, verbose_name=b'One to five star rating.', blank=True)),
            ],
            options={
                'ordering': ('-pub_date',),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('wordpress_id', models.IntegerField(help_text='The junky old wp_posts id from before the migration', unique=True, null=True, editable=False, blank=True)),
                ('title', models.CharField(help_text='Maximum 250 characters.', max_length=250)),
                ('slug', models.SlugField(help_text='Suggested value automatically generated from title.', max_length=300, unique_for_date=b'pub_date')),
                ('body_markup', models.TextField(help_text='The HTML of the post that is edited by the author.')),
                ('body_html', models.TextField(help_text='The HTML of the post run through Pygments.', null=True, editable=False, blank=True)),
                ('pub_date', models.DateTimeField(default=datetime.datetime.now, verbose_name='publication date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stratum', models.IntegerField(help_text=b'The font-size stratum to stick         this guy in when puffing up the cloud.')),
            ],
            options={
                'ordering': ('-count', 'name'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('track_mbid', models.CharField(max_length=36, verbose_name='MusicBrainz Track ID', blank=True)),
                ('artist_mbid', models.CharField(max_length=36, verbose_name='MusicBrainz Artist ID', blank=True)),
            ],
            options={
                'ordering': ('-pub_date',),
                'abstract': False,
